          ...
          pricingOptions.map((option, index) => (
            <div key={index} className='w-full sm:w-1/2 lg:w-1/3 p-2'>
              <div className='p-10 border border-neutral-700 rounded-xl'>
                ...
                <Link to="/subscribe" className='flex justify-center items-center w-full mt-20 tracking-tight text-xl border border-indigo-600 rounded-lg py-2 transition duration-300  hover:bg-indigo-600'>Subscribe</Link>
              </div>
            </div>
          ))
        }
