...
const HeroSection = () => {
  return (
    <div className='hero-whapper flex flex-col items-center mt-6'>
        ...
        <p className='mt-10 text-lg text-center text-neutral-500 max-w-4xl'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Recusandae, voluptas? Ratione sunt cum consequatur velit officiis saepe libero, perspiciatis recusandae eaque dolores tempora asperiores magni laboriosam soluta? Modi, repellat asperiores!</p>
        ...
        <div className='video-wrapper flex flex-col gap-2 md:flex-row mt-10 justify-center'>
          {
            videos.map((video, index) => (
              <video key={index} autoPlay loop muted className='rounded-lg w-full md:w-1/2 border-indigo-700 shadow-sm shadow-indigo-400 my-auto mx-auto md:my-4 md:my-2'>
